...
export default function Home() {
  ...
  return (
    <div className="">
      ...
      {/* Hero Section */}
      <div className="min-h-[500px] lg:h-[759px] relative">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-5 max-w-[1570px] mx-auto px-4 lg:px-[10px] text-white h-full py-12 lg:py-0">
          {/* Chap qism */}
          <div className="w-full lg:flex-1 lg:h-[572px] flex flex-col justify-center gap-[24px]">
            ...
            <h1 className="text-[38px] sm:text-[54px] lg:text-[72px] font-[800] leading-[44px] sm:leading-[60px] lg:leading-[76px]">
              Elektron  Kutubxona
              <br />
              <span className="text-[#266BE3]">Boshqaruv Tizimi</span>
            </h1>
            <p className="text-[#FCF8FF] text-[16px] lg:text-[20px] font-[300] w-full lg:w-[80%]">100,000+ kitob, ilmiy maqolalar va audiokitoblardan iborat raqamli kutubxonaga xush kelibsiz. O'qing, eshiting, kashf eting.</p>
          ...
          {/* O'ng qism - faqat desktop */}
          <div className="hidden lg:flex flex-1 h-[572px] flex-col justify-between pt-[22px]">
      ...
      <div className="max-w-[1570px] px-4 lg:px-[10px] mx-auto py-10">
        <h2 className="text-[#153965] text-[24px] lg:text-[32px] font-[700] mb-[28px]">Tavsiya etilgan kitoblar</h2>

        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-4 sm:gap-x-6 lg:gap-x-[50px] gap-y-[32px]">
          {products.map((item, index) => {
            return (
              <div key={index} className="w-full flex flex-col">
                <div className="relative w-full h-[220px] sm:h-[280px] lg:h-[374px] rounded-tr-[8px] rounded-br-[8px] overflow-hidden">
                ...
                <div className="flex-1 relative flex flex-col items-start justify-end pt-2">
                  <div className="flex items-center justify-between gap-2 w-full">
                    <p className="text-[13px] lg:text-[14px] font-[400]">{item.subtitle}</p>
                    <div className="flex items-center gap-2 text-[12px] font-[500]">
                      <Star size={13} fill="#F59E0B" className="text-[#F59E0B]" />
                      {item.rate}
                    </div>
                  </div>
                  <h3 className="text-[#1F2330] text-[15px] lg:text-[18px] font-[700] leading-[20px] lg:leading-[22px]">{item.title}</h3>
                  <p className="text-[#464652] text-[11px] lg:text-[12px] font-[400] leading-[18px] mt-[4px]">{item.author}</p>
                </div>
              </div>
            )
          })}
      ...
      <div className="mb-10 max-w-[1570px] mx-auto px-4 lg:px-[10px] py-[48px]">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4">
            <div>
              <p className="text-[#2A85F4] uppercase text-[12px] font-[700]">So'ngi yangiliklar</p>
              <h3 className="text-[#153965] text-[24px] lg:text-[30px] font-[800]">Kutubxona yangiliklari</h3>
              <p className="text-[#65758B] text-[14px] font-[400]">Yangi tadbirlar, nashrlar va e'lonlardan birinchi bo'lib xabardor bo'ling</p>
            </div>

            <a href="#" className="flex items-center gap-1 text-[#2A85F4] text-[14px] font-[700] hover:underline shrink-0">
              Barcha yangiliklar
          ...
          {/* Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[36px] mt-[36px] items-start">
            {/* Card 1 */}
            <div className="relative h-[480px] rounded-[28px] overflow-hidden bg-gradient-to-br from-[#102B4C] via-[#2E1F7A] to-[#6A288A] text-white px-[32px] py-[28px] flex flex-col justify-between">
              ...
              <div className="relative">
                <h4 className="text-[28px] lg:text-[32px] font-[800] leading-[34px] lg:leading-[36px]">
                  Kutubxonaga 5 000+
                  <br />
                  yangi ilmiy maqola
                  <br />
                ...
                <p className="text-[15px] font-[400] leading-[24px] text-white/75 mt-[14px]">
                  SamDU professorlari tomonidan tayyorlangan yangi nashrlar barcha foydalanuvchilar uchun ochiq kirimga qo'yildi.
                </p>
      ...
      {/* Trendda */}
      <div className="h-auto lg:h-[594px] bg-[#153965] mb-10 py-[48px] lg:py-0">
        <div className="max-w-[1570px] mx-auto px-4 lg:px-[10px] lg:py-[48px]">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4">
            <div>
              <p className="inline-block uppercase text-white text-[11px] font-[700] tracking-[1px] px-[14px] py-[6px] rounded-[20px] bg-white/10">
                Trendda
              </p>
              <h2 className="text-white text-[24px] lg:text-[36px] font-[800] leading-[32px] lg:leading-[44px] mt-[14px]">Bu hafta eng ko'p o'qilayotgan kitoblar</h2>
              <p className="text-white/60 text-[14px] font-[400] leading-[20px] mt-[4px]">
                Kitobxonlar tomonidan tanlangan eng yuqori reytingli asarlar to'plami
              </p>
            </div>

            <div className="flex items-center gap-[10px] pb-[4px] shrink-0">
          ...
          {/* Trenddagi kitoblar - horizontal scroll on mobile */}
          <div className="flex items-start gap-[24px] mt-[36px] overflow-x-auto pb-2 lg:justify-between scrollbar-hide">
            {products.slice(0, 7).map((item, index) => {
              return (
                <div key={index} className="w-[150px] sm:w-[170px] lg:w-[186px] shrink-0">
                  <div className="relative w-[150px] sm:w-[170px] lg:w-[186px] h-[200px] sm:h-[230px] lg:h-[247px] rounded-[16px] overflow-hidden bg-[#102B4C]">
      ...
      <div className="mb-10">
        <div className="max-w-[1570px] px-4 lg:px-[10px] mx-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between pt-[48px] gap-4">
            <div>
              <p className="text-[#2A85F4] uppercase text-[12px] font-[700] tracking-[1px]">Kategoriyalar</p>
              <h2 className="text-[#153965] text-[24px] lg:text-[30px] font-[800] leading-[32px] lg:leading-[38px] mt-[6px]">O'zingizga mos bo'limni tanlang</h2>
              <p className="text-[#65758B] text-[14px] font-[400] leading-[20px] mt-[4px]">Ilm va adabiyotning barcha sohalari bir joyda</p>
            </div>

            <a href="#" className="flex items-center gap-[6px] text-[#2A85F4] text-[14px] font-[700] pb-[4px] shrink-0">
              Barchasi
          ...
          {/* Kategoriya cardlar */}
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-[16px] lg:gap-[32px] mt-[30px] mb-10">
            <div className="relative h-[148px] border border-[#D7DEE8] rounded-[12px] px-[18px] py-[20px] flex flex-col justify-between hover:shadow-lg hover:scale-101 cursor-pointer transition-all duration-300 hover:duration-150">
              ...
              <div>
                <h3 className="text-[#153965] text-[15px] lg:text-[16px] font-[700]">Adabiyot</h3>
                <p className="text-[#65758B] text-[11px] lg:text-[12px] font-[400]">12 480 ta resurs</p>
              </div>
            </div>
            ...
            <div className="relative h-[148px] border border-[#D7DEE8] rounded-[12px] px-[18px] py-[20px] flex flex-col justify-between hover:shadow-lg hover:scale-101 cursor-pointer transition-all duration-300 hover:duration-150">
              ...
              <div>
                <h3 className="text-[#153965] text-[15px] lg:text-[16px] font-[700]">Ilmiy maqolalar</h3>
                <p className="text-[#65758B] text-[11px] lg:text-[12px] font-[400]">8 240 ta resurs</p>
              </div>
            </div>
            ...
            <div className="relative h-[148px] border border-[#D7DEE8] rounded-[12px] px-[18px] py-[20px] flex flex-col justify-between hover:shadow-lg hover:scale-101 cursor-pointer transition-all duration-300 hover:duration-150">
              ...
              <div>
                <h3 className="text-[#153965] text-[15px] lg:text-[16px] font-[700]">Tarix</h3>
                <p className="text-[#65758B] text-[11px] lg:text-[12px] font-[400]">4 130 ta resurs</p>
              </div>
            </div>
            ...
            <div className="relative h-[148px] border border-[#D7DEE8] rounded-[12px] px-[18px] py-[20px] flex flex-col justify-between hover:shadow-lg hover:scale-101 cursor-pointer transition-all duration-300 hover:duration-150">
              ...
              <div>
                <h3 className="text-[#153965] text-[15px] lg:text-[16px] font-[700]">Dasturlash</h3>
                <p className="text-[#65758B] text-[11px] lg:text-[12px] font-[400]">2 760 ta resurs</p>
              </div>
            </div>
            ...
            <div className="relative h-[148px] border border-[#D7DEE8] rounded-[12px] px-[18px] py-[20px] flex flex-col justify-between hover:shadow-lg hover:scale-101 cursor-pointer transition-all duration-300 hover:duration-150">
              ...
              <div>
                <h3 className="text-[#153965] text-[15px] lg:text-[16px] font-[700]">Audio kitoblar</h3>
                <p className="text-[#65758B] text-[11px] lg:text-[12px] font-[400]">1 200 ta resurs</p>
              </div>
            </div>
            ...
            <div className="relative h-[148px] border border-[#D7DEE8] rounded-[12px] px-[18px] py-[20px] flex flex-col justify-between hover:shadow-lg hover:scale-101 cursor-pointer transition-all duration-300 hover:duration-150">
              ...
              <div>
                <h3 className="text-[#153965] text-[15px] lg:text-[16px] font-[700]">Mualliflar</h3>
                <p className="text-[#65758B] text-[11px] lg:text-[12px] font-[400]">640 ta resurs</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1570px] mx-auto px-4 lg:px-[10px]">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4">
            <div>
              ...
              <h2 className="text-[#153965] text-[24px] lg:text-[30px] font-[800] leading-[30px] lg:leading-[36px] mt-[6px]">So'nggi qo'shilgan asarlar</h2>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[24px] mt-[34px]">
            {/* Card 1 */}
      ...
      <div className="w-full py-10">
        <div className="max-w-[1570px] px-4 lg:px-[10px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-[20px]">
            {/* Mashhur yozuvchilar */}
            <div className="lg:col-span-2 border border-[#D7DEE8] rounded-[24px] px-[24px] lg:px-[34px] py-[28px] bg-white">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-[#2A85F4] uppercase text-[12px] font-[700] tracking-[1px]">Mualliflar</p>
                  <h2 className="text-[#153965] text-[20px] lg:text-[22px] font-[700] leading-[28px] mt-[4px]">Mashhur yozuvchilar</h2>
                </div>
                <a href="#" className="text-[#2A85F4] text-[14px] font-[500]">Barchasi</a>
              </div>

              <div className="grid grid-cols-3 sm:grid-cols-6 gap-[16px] lg:gap-[24px] mt-[28px]">
                {[
                  { init: "CH", name: "Cho'lpon", count: "24 asar", grad: "from-[#2A85F4] to-[#5B47F5]" },
                  { init: "AQ", name: "A. Qodiriy", count: "18 asar", grad: "from-[#E8306E] to-[#FF674D]" },
                  { init: "OH", name: "O. Hoshimov", count: "32 asar", grad: "from-[#28AF60] to-[#1AC3E6]" },
                  { init: "SA", name: "Said Ahmad", count: "21 asar", grad: "from-[#FF8A24] to-[#F43B4F]" },
                  { init: "XT", name: "X. To'xtaboyev", count: "15 asar", grad: "from-[#8C35E8] to-[#D126C5]" },
                  { init: "EV", name: "Erkin Vohidov", count: "27 asar", grad: "from-[#168DE2] to-[#075BDE]" },
                ].map((a) => (
                  <div key={a.init} className="flex flex-col items-center">
                    <div className={`w-[56px] h-[56px] lg:w-[64px] lg:h-[64px] rounded-full bg-gradient-to-br ${a.grad} text-white text-[16px] lg:text-[18px] font-[700] flex items-center justify-center`}>{a.init}</div>
                    <h3 className="text-[#153965] text-[11px] lg:text-[12px] font-[600] mt-[10px] text-center">{a.name}</h3>
                    <p className="text-[#65758B] text-[10px] font-[400]">{a.count}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Premium */}
            <div className="relative overflow-hidden rounded-[24px] bg-gradient-to-br from-[#102B4C] via-[#2E1F7A] to-[#6A288A] px-[32px] py-[28px] text-white min-h-[200px] lg:min-h-0">
              ...
              <div className="relative h-full flex flex-col justify-between gap-6">
                <div className="flex flex-col items-start">
                  ...
                  <h2 className="text-[22px] lg:text-[24px] font-[800] leading-[28px] lg:leading-[30px] mt-[16px]">
          ...
          {/* Statistika */}
          <div className="border border-[#D7DEE8] rounded-[24px] bg-white mt-[18px] px-[20px] lg:px-[34px] py-6 lg:py-0 lg:h-[114px] grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-0 items-center">
            <div className="flex items-center gap-[16px]">
              <div className="w-[48px] h-[48px] rounded-[12px] bg-[#EAF3FF] text-[#2A85F4] flex items-center justify-center shrink-0">
                <BookOpen size={23} strokeWidth={2} />
              </div>
              <div>
                <p className="text-[#153965] text-[22px] lg:text-[24px] font-[800] leading-[28px]">100K+</p>
            ...
            <div className="flex items-center gap-[16px]">
              ...
              <div>
                <p className="text-[#153965] text-[22px] lg:text-[26px] font-[800] leading-[28px]">25K</p>
            ...
            <div className="flex items-center gap-[16px]">
              ...
              <div>
                <p className="text-[#153965] text-[22px] lg:text-[26px] font-[800] leading-[28px]">1.2K</p>
            ...
            <div className="flex items-center gap-[16px]">
              ...
              <div>
                <p className="text-[#153965] text-[22px] lg:text-[26px] font-[800] leading-[28px]">24</p>
