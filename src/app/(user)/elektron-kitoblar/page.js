...
import { ArrowRight, BookOpen, Bookmark, ChevronRight, Eye, Filter, Grid3X3, Headphones, List, Search, Star, X } from "lucide-react";
...
export default function ElektronKitoblar() {
    ...
    const FilterSidebar = () => (
        <div className="w-full lg:w-[280px] lg:shrink-0 space-y-[24px]">
            ...
            <div className="h-[167px] rounded-[16px] bg-gradient-to-br from-[#102B4C] to-[#6A288A] p-[24px] text-white">
    ...
    return (
        <div>
            {/* Hero */}
            <div className="relative min-h-[280px] lg:h-[373px] bg-gradient-to-r from-[#153965] via-[#2E1F7A] to-[#6A288A]">
                <div className="max-w-[1570px] mx-auto px-4 lg:px-[10px] h-full">
                    <div className="w-full h-full mx-auto pt-[48px] lg:pt-[64px]">
                        {/* Breadcrumb */}
                        ...
                        <div className="mt-[24px] lg:mt-[34px]">
                            ...
                            <h1 className="text-white text-[36px] sm:text-[48px] lg:text-[64px] font-[800] leading-[42px] sm:leading-[56px] lg:leading-[72px] mt-[10px]">
                                Elektron <span className="text-[#2A85F4]">kitoblar</span>
                            </h1>
                            <p className="max-w-[650px] text-white/70 text-[15px] lg:text-[18px] font-[400] leading-[24px] lg:leading-[28px] mt-[14px]">
                                100 000+ kitob, audio asarlar va video kurslar to'plamini bir joyda qidiring, o'qing va yuklab oling.
                            </p>
                        </div>
                    </div>

                    {/* Search */}
                    <div className="absolute left-1/2 -translate-x-1/2 -bottom-[37px] w-full max-w-[1570px] px-4 lg:px-[10px]">
                        <div className="h-[64px] lg:h-[72px] rounded-[16px] lg:rounded-[20px] bg-white shadow-[0_14px_35px_#15396540] px-[16px] lg:px-[22px] flex items-center gap-[12px] lg:gap-[18px]">
                            <Search className="text-[#65758B] shrink-0" size={22} />
                            <input
                                type="text"
                                placeholder="Kitob nomi, muallif yoki ISBN..."
                                className="flex-1 h-full outline-none text-[#153965] text-[14px] lg:text-[15px] placeholder:text-[#94A3B8] min-w-0"
                            />
                            <button className="hidden sm:flex h-[44px] lg:h-[48px] px-[16px] lg:px-[20px] rounded-[10px] lg:rounded-[12px] border border-[#D7DEE8] text-[#153965] text-[13px] lg:text-[14px] font-[600] items-center gap-[8px] shrink-0 cursor-pointer">
                                <Filter size={16} />
                                Kengaytirilgan
                            </button>
                            <button className="h-[44px] lg:h-[48px] px-[18px] lg:px-[24px] rounded-[10px] lg:rounded-[12px] bg-[#2A85F4] text-white text-[13px] lg:text-[14px] font-[700] flex items-center gap-[8px] shrink-0 cursor-pointer active:scale-95 transition-all duration-150">
                                Qidirish
                                <ArrowRight size={16} />
                            </button>
                        </div>
            ...
            {/* Products */}
            <div className="bg-[#F9FAFC] pt-[64px] mt-10 lg:mt-17 pb-16">
                <div className="max-w-[1570px] mx-auto px-4 lg:px-[10px]">
                    ...
                    <div className="lg:hidden mb-4">
                        <button
                            ...
                            className="h-[44px] px-[18px] rounded-[10px] border border-[#D7DEE8] bg-white text-[#153965] text-[14px] font-[700] flex items-center gap-[8px] cursor-pointer"
                        >
                            <Filter size={16} className="text-[#2A85F4]" />
                            Filtrlar
                    ...
                    <div className="flex gap-[36px] items-start">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="h-[42px] flex items-center justify-between mb-[24px]">
                                <p className="text-[#153965] text-[13px] lg:text-[14px] font-[800] leading-[20px]">{currentBooks.length} ta natija topildi</p>

                                <div className="flex items-center gap-[10px]">
                                    <button className="hidden sm:flex h-[40px] w-[130px] lg:w-[139px] rounded-[8px] border border-[#D7DEE8] bg-white px-[14px] items-center justify-between text-[#153965] text-[13px] font-[700]">
                                        Mashhurlik
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[16px] lg:gap-y-[24px]">
                                {currentBooks.map((book) => (
                                    <Link
                                        href={`/elektron-kitoblar/${book.id}`}
                                        key={book.id}
                                        className="w-full rounded-[16px] lg:rounded-[20px] overflow-hidden border border-[#D7DEE8] bg-white flex flex-col group hover:shadow-lg transition-all cursor-pointer"
                                    >
                                        <div className={`relative h-[140px] sm:h-[160px] lg:h-[192px] bg-gradient-to-br ${book.gradient} flex items-center justify-center`}>
                                            <span className="absolute left-[12px] top-[12px] h-[24px] px-[10px] rounded-full bg-white/20 text-white text-[10px] font-[700] flex items-center">
                                                {book.type}
                                            </span>
                                            <span className={`absolute right-[12px] top-[12px] h-[24px] px-[10px] rounded-full text-white text-[10px] font-[800] flex items-center ${book.access === "BEPUL" ? "bg-[#22C55E]" : "bg-[#FFB020]"}`}>
                                                {book.access}
                                            </span>
                                            <BookOpen size={40} strokeWidth={2.2} className="text-white group-hover:scale-105 transition-transform" />
                                            <button
                                                onClick={(e) => e.preventDefault()}
                                                className="absolute right-[12px] bottom-[12px] w-[34px] h-[34px] rounded-full bg-white/20 text-white flex items-center justify-center hover:bg-white/30 active:scale-95 transition-all"
                                            >
                                                <Bookmark size={16} strokeWidth={2.2} />
                                            </button>
                                        </div>

                                        <div className="flex-1 px-[14px] lg:px-[22px] pt-[16px] lg:pt-[24px] pb-[14px] lg:pb-[20px] flex flex-col justify-between">
                                            <div className="flex flex-col gap-1">
                                                <p className="text-[#2A85F4] text-[10px] lg:text-[11px] font-[800] leading-[14px] tracking-[1px]">{book.category}</p>
                                                <h3 className="text-[#153965] text-[14px] lg:text-[18px] font-[800] leading-[18px] lg:leading-[24px] line-clamp-2 group-hover:text-[#2A85F4] transition-colors">{book.title}</h3>
                                                <p className="text-[#65758B] text-[12px] lg:text-[13px] font-[500] leading-[18px] mt-[6px] lg:mt-[10px]">{book.author}</p>
                                            </div>

                                            <div className="space-y-[10px] lg:space-y-[16px] mt-3">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-[6px]">
                                                        <Star size={14} className="fill-[#F5B400] text-[#F5B400]" />
                                                        <span className="text-[#153965] text-[12px] lg:text-[13px] font-[800]">{book.rating}</span>
                                                    </div>
                                                    <div className="flex items-center gap-[4px] text-[#65758B] text-[12px] lg:text-[13px] font-[500]">
                                                        <Eye size={13} strokeWidth={2} />
                                                        {book.views}
                                                    </div>
                                                </div>

                                                <div className="w-full h-[38px] lg:h-[46px] rounded-[9px] lg:rounded-[11px] bg-[#EAF3FF] text-[#2A85F4] text-[13px] lg:text-[14px] font-[800] flex items-center justify-center gap-[6px] group-hover:bg-[#2A85F4] group-hover:text-white transition-all">
                            ...
                            <div className="mt-[36px] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                ...
                                <div className="flex items-center gap-[7px]">
                                    {[1, 2, 3, 4, 5].map((number) => (
                                        <button
                                            ...
                                            className={`w-[36px] lg:w-[38px] h-[36px] lg:h-[38px] rounded-[10px] border text-[13px] font-[800] ${page === number ? "bg-[#153965] border-[#153965] text-white" : "bg-white border-[#D7DEE8] text-[#153965]"}`}
                                        >
                                            {number}
                                        </button>
                                    ))}
                                    ...
                                    <button
                                        ...
                                        className={`w-[40px] lg:w-[42px] h-[36px] lg:h-[38px] rounded-[10px] border text-[13px] font-[800] ${page === totalPages ? "bg-[#153965] border-[#153965] text-white" : "bg-white border-[#D7DEE8] text-[#153965]"}`}
                                    >
                                        {totalPages}
                                    </button>
                                </div>
